...
For each paper or publication, you will be creating a **preregistration** and a **publication package.** Preregistrations will be published on the GUTS OSF page, where you will also find some preregistration templates. Guidelines may vary per institution, but a preregistration typically
includes:
