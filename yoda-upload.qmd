...
For major data uploads like MRI or EEG data there is a way to use curl to send the data to your Yoda workspace using a variation of the following command:\
